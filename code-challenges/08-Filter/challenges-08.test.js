...
const filterStringsWithVowels = (arr) => {
  // Solution code here.
  return arr.filter(ele=>{
    return ele.includes('a') ||ele.includes('e')  || ele.includes('i') ||  ele.includes('u') || ele.includes('o') 
  })
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  return arr.filter(ele =>{
  return ele.baseStat>minBaseStat; 
  })
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  var array= getBaseStatGreaterThan(arr,minBaseStat);
  return array.map(elemanto=>{
    return elemanto.stat.name;
  })
};
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  var numberarr=arr.filter(ele=>{
    return typeof(ele)==="number";
  })
  return numberarr.map(ele=>{
  if (ele%2){
    return 'odd';
    }
  else {
